...
#TND
##Single 450, balanced antibody distribution
```{r}
df_original <- read_csv('50000_simulation_1028_linear_450.csv')
...
##Single 100, unbalanced antibody distribution
```{r}
df_original <- read_csv('50000_simulation_1028_linear_100.csv')
...
##Compiled 400-500, balanced antibody distribution
```{r}
steps <- seq(400,500,10)
...
##Compiled 100-200, unbalanced antibody distribution
```{r}
steps <- seq(100,200,10)
results_list <- lapply(steps, function(step) {
  file_path <- paste0("50000_simulation_1028_linear_", step, ".csv")
  df_original <- read.csv(file_path)
  df_original$day <- step
